...
gathered_preproc = np.zeros((30, 4, 5, 6))
data_indx = 0
for i, (root, dirs, files) in enumerate(os.walk("../results/cart")):
    for filename in files:
        filepath = root + os.sep + filename
