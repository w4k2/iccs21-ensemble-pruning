...
def worker(d_indx, key, data):
    ...
    clfs = {
        "MV-CART": StratifiedBagging(base_estimator = b, ensemble_size=n_estimators, acc_prob=False, random_state=1410),
        "ACC-CART": StratifiedBagging(base_estimator = b, ensemble_size=n_estimators, acc_prob=True, random_state=1410),
        "PRUNE-CART":
        CMOE(base_estimator=base_clf, random_state=1410, diversity="kw", hard_voting=acc_prob)
    }
