...
def worker(d_indx, key, data):
    ...
    clfs = {
        "MV-CART-ROS": StratifiedBagging(base_estimator = b, ensemble_size=n_estimators, acc_prob=True, random_state=1410, oversampled="ROS"),
        "MV-CART-SMOTE": StratifiedBagging(base_estimator = b, ensemble_size=n_estimators, acc_prob=True, random_state=1410, oversampled="SMOTE"),
        "MV-CART-SVMSMOTE": StratifiedBagging(base_estimator = b, ensemble_size=n_estimators, acc_prob=True, random_state=1410, oversampled="SVMSMOTE"),
        "MV-CART-B2SMOTE": StratifiedBagging(base_estimator = b, ensemble_size=n_estimators, acc_prob=True, random_state=1410, oversampled="B2SMOTE"),
    }
    ...
    np.save("results/cart/cart_%s_preproc" % key, scores)
